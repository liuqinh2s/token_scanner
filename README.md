...
| K线筛 | 历史最高价≤$0.00004、前2h最高价≤$0.00002(币龄>2h)、当前价在最高价10%~80% | DexScreener (主) + GeckoTerminal (备) | 每候选 1~3 请求 |
...
| `PRICE_RATIO_LOW` | 0.1 | 当前价/最高价 下限 (10%) |
