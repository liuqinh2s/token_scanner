...
4. 精筛 (瞬时)
   标签制精筛: 统一通道, 基础标签全部满足(持币≥30/进度≥15%或流动性≥$10k/仿盘≥5/未崩盘/社交≥1/有动能)
   + 加分项至少1个(Boost/仿盘≥100/持币增长≥20/社交≥3/已毕业强势/进度增长≥10%/加速增长/首轮强势)
   → 从存活币中找蓄势待发信号
...
| 社交 | ≥ 1 | 有基本运营 |
| 动能 | 近1轮持币增速≥5 或 进度增长≥5% | 必须有增长动能，过滤静态达标的僵尸币。首轮豁免：首轮入队无历史数据时，持币≥100 + 进度≥50%/流动性≥$15k 视为有动能 |
...
| 首轮强势 | 首轮入队且满足豁免条件（持币≥100 + 进度≥50%/流动性≥$15k），自带加分 |
