...
| K线筛 | 历史最高价≤$0.00004、前2h最高价≤$0.00002(币龄>1h)（币龄<4h且价>$0.00001时放宽至$0.000023）、当前价在最高价40%~90%、现价比底价高10%~100%(币龄>1h,排除首根K线) | DexScreener (主) + GeckoTerminal (备) | 每候选 1~3 请求 |
...
4. **底部区间**（币龄 > 1h）：当前价比除第一根 K 线外的所有 1h K 线最低价高 10%~100%
