...
# 数据基础: 1046轮扫描, 73769个代币, 全量回测
# v7→v8 核心改进: 双动能(AND)改为单动能(OR), 持币增长或价格上涨任一即可
# 回测对比 (11天全量数据):
#   旧策略(双动能h20+cc3):  买入242, 胜率73.1%, 翻倍37, 净赚220
#   新策略(单动能h20+cc3):  买入329, 胜率71.1%, 翻倍56, 净赚277
# 单动能多捕获19个翻倍币, 净赚多26%, 胜率仅降2个百分点
#
# 基础标签组 (全部满足, AND):
#   1. 持币数 ≥ 20 (从30降低, 更早发现)
...
# flap 社交豁免: flap 代币普遍无社交链接, 当持币数和进度足够强时豁免社交要求
