...
精筛条件 (动量筛选):
  ...
  - 🎓 毕业通道 (刚毕业强势币, 跳过慢条件): 已毕业 + 币龄≤2h + 持币≥100 + 流动性≥$10k + 价格≤3e-04 + 回撤≤30%
  - 币龄 ≥ 1 小时 (太短归零风险大)
  - 币龄 ≤ 36 小时 (太老失去市场关注)
...
GRAD_MAX_PRICE = 0.0003               # 毕业: 价格 ≤ 0.0003 (快速毕业币价格可能超过突破线)
...
def main():
    ...
    # breakthroughTokens: 从 survivors 中提取已突破代币 (实时数据, 同时出现在队列和已突破 tab)
    out_breakthrough = []
