...
5. **`token_trading/README.md`** — 同步更新淘汰规则表、精筛规则表、配置参数表
6. **`site/index.html`** — 通过 `npm run build` 重新生成
...
- **持仓止盈止损监控频率**：姊妹项目 `token_trading` 的 `trader.py` 每 1 分钟检查一次持仓盈亏，独立于扫描周期
